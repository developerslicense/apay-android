            ...
            ConstraintLayout {
                ...
                Column(
                    ...
                    Button(
                        ...
                        Text("Стандартный флоу + ввод JWT")
                    }
                    ...
                    Text(
                        text = "Настройки только для стандартного флоу (без \"+\")",
...
private fun DropdownList(
    ...
    if (showDropdown.value) {
        ...
        Button(
            ...
            content = {
                if (isRender.value == true) {
                    Text(
                        text = title1,
                        modifier = Modifier.padding(3.dp)
                    )
                }
                if (isRender.value == false) {
                    Text(
                        text = title2,
                        modifier = Modifier.padding(3.dp)
                    )
                }
                if (isRender.value == null) {
                    Text(
                        text = title3,
                        modifier = Modifier.padding(3.dp)
                    )
