...
import kz.airbapay.apay_android.ui.pages.card_reader2.models.RunArguments;

public class MLThread implements Runnable {
    LinkedList<RunArguments> queue = new LinkedList<>();
...
/*
    ...
    private void runOcrModel(final Bitmap bitmap, final RunArguments args) {
        ...
        handler.post(() -> {
            try {
                args.getMScanListener();
                args.getMScanListener().onPrediction("", bitmap, null);
            } catch (Error | Exception e) {
