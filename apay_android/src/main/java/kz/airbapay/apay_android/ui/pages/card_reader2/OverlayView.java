...
class OverlayView extends View {
    ...
    private final WeakReference<NewCardIOActivity> mScanActivityRef;
...
//    private final Logo mLogo;
    ...
    public OverlayView(NewCardIOActivity captureActivity, AttributeSet attributeSet, boolean showTorch) {
        super(captureActivity, attributeSet);

        mShowTorch = showTorch;
        mScanActivityRef = new WeakReference<NewCardIOActivity>(captureActivity);
