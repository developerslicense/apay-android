...
internal class ExternalStandardFlowWebViewActivity: BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Logger.log(
            message = "onCreate ExternalStandardFlowWebViewActivity. url = $url",
        )

        setContent {
            ExternalStandardFlowWebViewPage(url = url)
        }
    }
...
@Composable
internal fun ExternalStandardFlowWebViewPage(
    url: String?
) {
            ...
            AndroidView(
                factory = {
                    WebView(it).apply {
                        ...
                        webViewClient = ExternalStandardFlowWebViewClient(
                            activity = activity,
