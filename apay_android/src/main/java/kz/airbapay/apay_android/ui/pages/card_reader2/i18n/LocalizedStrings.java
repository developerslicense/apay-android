package kz.airbapay.apay_android.ui.pages.card_reader2.i18n;
...
import kz.airbapay.apay_android.ui.pages.card_reader2.i18n.locales.LocalizedStringsList;
...
public final class LocalizedStrings {
    ...
    public static void setLanguage(Intent intent) {
        i18nManager.setLanguage(intent.getStringExtra(NewCardIOActivity.EXTRA_LANGUAGE_OR_LOCALE));
    }
