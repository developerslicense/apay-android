...
1) Добавьте кнопку GooglePay и код для взяимодействия с ней, используя документацию GooglePay или samples из github гугла.

2) Выполните AirbaPaySdk.initOnCreate(). Если есть необходимость скрывать на страницах сдк кнопку GooglePay, то во всех случаях вызова initOnCreate используйте флаг hideInternalGooglePayButton = true. 
